...
class Models_JingluoNames:
    ...
    jl_middle_up_nei = jl_shenjing_shangshen + \
        jl_xingbao + jl_fei + jl_wei_middle + jl_dan_middle
    ...
    modelCfg = {
        ...
        "left_hand_middle_up_nei": {
            ...
            "accuNames": ["L-xinbao-6", "L-xinbao-7", "L-xinbao-8", "L-xinbao-9", "L-fei-6", "L-fei-7", "L-fei-8"],
        },
        "right_hand_middle_up_nei": {
            "cfg": ["right_hand_middle_up_nei.yaml", "right_hand_middle_up_nei.pth", "detectron2", "r"],
            "accuNames": ["R-xinbao-6", "R-xinbao-7", "R-xinbao-8", "R-xinbao-9", "R-fei-6", "R-fei-7", "R-fei-8"],
        },
    ...
    def getJingluo_AccuDictAbberv(self):
        ...
        jadictAbbr["pis2"] = ["pi", (15, 15), (9, 9), (15,19)]

        jadictAbbr["fei"] = ["fei", (1, 8)]
        jadictAbbr["xinbao"] = ["xinbao", (1, 7), (6, 6), (8, 9)]  # 1-9
        ...
        # 大肠
        jadictAbbr["dachang"] = ["dachang", (1, 5), (20, 20), (6, 8)]  # 1,8

        # 小肠
        jadictAbbr["xiaochang"] = ["xiaochang",
                                   (1, 4), (20, 20), (5, 11)]  # 1,12 机械臂相撞

        # 膀胱
        # jadictAbbr["pangguang"] = [(9, 24)]  #9,26 机械臂相撞
        jadictAbbr["pangguangs1"] = ["pangguang", (9, 17)]
        jadictAbbr["pangguangs2"] = ["pangguang", (18, 23),(17, 17),(24, 26)]
        jadictAbbr["dan"] = ["dan", (22, 25), (53, 53), (51, 51), (26,26), (52,52), (50,50), (27, 31), (37, 41)]
        # jadictAbbr["dan"] = ["dan", (22, 31), (37, 41)]

        jadictAbbr["wei"] = ["wei", (15, 28), (26, 26), (29, 30)]  # 15,30
...
21,31),(34,41
        ...
        # 胆经有一部分点 放在中间模型上(dan 26 51 52)
        jingluo_modelDict["dan_r"] = ["middle_up_nei", "right_up_nei"]
        jingluo_modelDict["dan_l"] = ["middle_up_nei", "left_up_nei"]
